          ...
          <div className="container mx-auto px-4">
            <ScrollAnimation direction="left">
              <div>
                ...
                <h2 className="text-3xl font-bold mb-6">Industrial Grade IPCs</h2>
                <p className="text-gray-600 mb-6">
                  Rugged industrial grade industrial PCs for harsh environments, designed for reliable performance in defense and industrial applications.
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <Card className="text-center">
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-600">Meets military standards for durability and reliability</p>
                  </CardContent>
                </Card>
                <Card className="text-center">
                  <CardContent className="p-6">
                    <Zap className="mx-auto mb-4 text-tech-blue" size={48} />
                    <h4 className="text-lg font-semibold mb-2">Extended Temperature Range</h4>
                    <p className="text-gray-600">Operates reliably in extreme temperatures</p>
                  </CardContent>
                </Card>
                <Card className="text-center">
                  <CardContent className="p-6">
                    <CheckCircle className="mx-auto mb-4 text-tech-blue" size={48} />
                    <h4 className="text-lg font-semibold mb-2">Shock Resistant</h4>
                    <p className="text-gray-600">Built to withstand high-impact conditions</p>
                  </CardContent>
                </Card>
              </div>
            </ScrollAnimation>
